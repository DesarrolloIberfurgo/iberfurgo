<div class="reservation-form-shadow">
    <form action="#" method="post" name="car-select-form" class="car-select-form" autocomplete="off">
        ...
        <select name="car-select" class="xs--select car-select">
            <option><?php echo esc_html( $reservation_form_car_type_title ); ?></option>
            <?php
        ...
        <div class="rental-datetime">
            ...
            <div class="input-group">
                <div class="date">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="<?php echo esc_attr( $car_pickup_date_icon ); ?>"></span><?php echo esc_html( $car_pickup_title ); ?></span>
                        <input type="text" style="--placeholder-color: <?php echo esc_attr( $car_reservation_input_location_color )?>" name="pick-up-date" class="form-control datepicker pick-up-date" placeholder="<?php echo esc_attr( "dd/mm/yyyy" ); ?>">
                    </div>
                </div>
                <div class="time">
            ...
            <div class="input-group">
                <div class="date">
                    <div class="input-group">
                        ...
                        <input type="text" style="--placeholder-color: <?php echo esc_attr( $car_reservation_input_location_color )?>" name="drop-off-date" class="form-control datepicker drop-off-date" placeholder="<?php echo esc_attr( "dd/mm/yyyy" ); ?>">
                    </div>
                </div>
                <div class="time">
                    <div class="styled-select-time">
