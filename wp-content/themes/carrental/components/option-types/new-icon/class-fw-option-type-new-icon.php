...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = CARRENTAL_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( CARRENTAL_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'carrental' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'carrental' ),
					'hand'				 => esc_html__( 'Hand Icons', 'carrental' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'carrental' ),
					'gender'			 => esc_html__( 'Gender Icons', 'carrental' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'carrental' ),
					'payment'			 => esc_html__( 'Payment Icons', 'carrental' ),
					'currency'			 => esc_html__( 'Currency Icons', 'carrental' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'carrental' ),
					'directional'		 => esc_html__( 'Directional Icons', 'carrental' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'carrental' ),
					'brand'				 => esc_html__( 'Brand Icons', 'carrental' ),
					'medical'			 => esc_html__( 'Medical Icons', 'carrental' ),
					'carrental-icons'	 => esc_html__( 'CarRental Icons', 'carrental' ),
				),
				'icons'				 => array(
					...
					'icon icon-strategicservices_icon1' => array('group' => 'carrental-icons'),
					'icon icon-strategicservices_icon3' => array('group' => 'carrental-icons'),
					'icon icon-strategicservices_icon4' => array('group' => 'carrental-icons'),
					'icon icon-strategicservices_icon5' => array('group' => 'carrental-icons'),
					'icon icon-strategicservices_icon6' => array('group' => 'carrental-icons'),
					'icon icon-strategicservices_icon7' => array('group' => 'carrental-icons'),
					'icon icon-strategicservices_icon8' => array('group' => 'carrental-icons'),
					'icon icon-post_icon1' => array('group' => 'carrental-icons'),
					'icon icon-post_icon2' => array('group' => 'carrental-icons'),
					'icon icon-post_icon3' => array('group' => 'carrental-icons'),
					'icon icon-post_icon4' => array('group' => 'carrental-icons'),
					'icon icon-post_icon5' => array('group' => 'carrental-icons'),
					'icon icon-application_icon' => array('group' => 'carrental-icons'),
					'icon icon-opened_positions_icon1' => array('group' => 'carrental-icons'),
					'icon icon-opened_positions_icon2' => array('group' => 'carrental-icons'),
					'icon icon-about_us_icon1' => array('group' => 'carrental-icons'),
					'icon icon-about_us_icon2' => array('group' => 'carrental-icons'),
					'icon icon-about_us_icon3' => array('group' => 'carrental-icons'),
					'icon icon-about_us_icon4' => array('group' => 'carrental-icons'),
					'icon icon-About-2' => array('group' => 'carrental-icons'),
					'icon icon-About-3' => array('group' => 'carrental-icons'),
					'icon icon-About-4' => array('group' => 'carrental-icons'),
					'icon icon-About' => array('group' => 'carrental-icons'),
					'icon icon-Banner_current' => array('group' => 'carrental-icons'),
					'icon icon-Banner_factory-1' => array('group' => 'carrental-icons'),
					'icon icon-Banner_factory' => array('group' => 'carrental-icons'),
					'icon icon-Banner_pumpjack' => array('group' => 'carrental-icons'),
					'icon icon-Funfacts-2' => array('group' => 'carrental-icons'),
					'icon icon-Funfacts-3' => array('group' => 'carrental-icons'),
					'icon icon-Funfacts-4' => array('group' => 'carrental-icons'),
					'icon icon-Funfacts' => array('group' => 'carrental-icons'),
					'icon icon-mobile' => array('group' => 'carrental-icons'),
					'icon icon-laptop' => array('group' => 'carrental-icons'),
					'icon icon-desktop' => array('group' => 'carrental-icons'),
					'icon icon-tablet' => array('group' => 'carrental-icons'),
					'icon icon-phone' => array('group' => 'carrental-icons'),
					'icon icon-document' => array('group' => 'carrental-icons'),
					'icon icon-documents' => array('group' => 'carrental-icons'),
					'icon icon-search' => array('group' => 'carrental-icons'),
					'icon icon-clipboard' => array('group' => 'carrental-icons'),
					'icon icon-newspaper' => array('group' => 'carrental-icons'),
					'icon icon-notebook' => array('group' => 'carrental-icons'),
					'icon icon-book-open' => array('group' => 'carrental-icons'),
					'icon icon-browser' => array('group' => 'carrental-icons'),
					'icon icon-calendar' => array('group' => 'carrental-icons'),
					'icon icon-presentation' => array('group' => 'carrental-icons'),
					'icon icon-picture' => array('group' => 'carrental-icons'),
					'icon icon-pictures' => array('group' => 'carrental-icons'),
					'icon icon-video' => array('group' => 'carrental-icons'),
					'icon icon-camera' => array('group' => 'carrental-icons'),
					'icon icon-printer' => array('group' => 'carrental-icons'),
					'icon icon-toolbox' => array('group' => 'carrental-icons'),
					'icon icon-briefcase' => array('group' => 'carrental-icons'),
					'icon icon-wallet' => array('group' => 'carrental-icons'),
					'icon icon-gift' => array('group' => 'carrental-icons'),
					'icon icon-bargraph' => array('group' => 'carrental-icons'),
					'icon icon-grid' => array('group' => 'carrental-icons'),
					'icon icon-expand' => array('group' => 'carrental-icons'),
					'icon icon-focus' => array('group' => 'carrental-icons'),
					'icon icon-edit' => array('group' => 'carrental-icons'),
					'icon icon-adjustments' => array('group' => 'carrental-icons'),
					'icon icon-ribbon' => array('group' => 'carrental-icons'),
					'icon icon-hourglass' => array('group' => 'carrental-icons'),
					'icon icon-lock' => array('group' => 'carrental-icons'),
					'icon icon-megaphone' => array('group' => 'carrental-icons'),
					'icon icon-shield' => array('group' => 'carrental-icons'),
					'icon icon-trophy' => array('group' => 'carrental-icons'),
					'icon icon-flag' => array('group' => 'carrental-icons'),
					'icon icon-map' => array('group' => 'carrental-icons'),
					'icon icon-puzzle' => array('group' => 'carrental-icons'),
					'icon icon-basket' => array('group' => 'carrental-icons'),
					'icon icon-envelope' => array('group' => 'carrental-icons'),
					'icon icon-streetsign' => array('group' => 'carrental-icons'),
					'icon icon-telescope' => array('group' => 'carrental-icons'),
					'icon icon-gears' => array('group' => 'carrental-icons'),
					'icon icon-key' => array('group' => 'carrental-icons'),
					'icon icon-paperclip' => array('group' => 'carrental-icons'),
					'icon icon-attachment' => array('group' => 'carrental-icons'),
					'icon icon-pricetags' => array('group' => 'carrental-icons'),
					'icon icon-lightbulb' => array('group' => 'carrental-icons'),
					'icon icon-layers' => array('group' => 'carrental-icons'),
					'icon icon-pencil' => array('group' => 'carrental-icons'),
					'icon icon-tools' => array('group' => 'carrental-icons'),
					'icon icon-tools-2' => array('group' => 'carrental-icons'),
					'icon icon-scissors' => array('group' => 'carrental-icons'),
					'icon icon-paintbrush' => array('group' => 'carrental-icons'),
					'icon icon-magnifying-glass' => array('group' => 'carrental-icons'),
					'icon icon-circle-compass' => array('group' => 'carrental-icons'),
					'icon icon-linegraph' => array('group' => 'carrental-icons'),
					'icon icon-mic' => array('group' => 'carrental-icons'),
					'icon icon-strategy' => array('group' => 'carrental-icons'),
					'icon icon-beaker' => array('group' => 'carrental-icons'),
					'icon icon-caution' => array('group' => 'carrental-icons'),
					'icon icon-recycle' => array('group' => 'carrental-icons'),
					'icon icon-anchor' => array('group' => 'carrental-icons'),
					'icon icon-profile-male' => array('group' => 'carrental-icons'),
					'icon icon-profile-female' => array('group' => 'carrental-icons'),
					'icon icon-bike' => array('group' => 'carrental-icons'),
					'icon icon-wine' => array('group' => 'carrental-icons'),
					'icon icon-hotairballoon' => array('group' => 'carrental-icons'),
					'icon icon-globe' => array('group' => 'carrental-icons'),
					'icon icon-genius' => array('group' => 'carrental-icons'),
					'icon icon-map-pin' => array('group' => 'carrental-icons'),
					'icon icon-dial' => array('group' => 'carrental-icons'),
					'icon icon-chat' => array('group' => 'carrental-icons'),
					'icon icon-heart' => array('group' => 'carrental-icons'),
					'icon icon-cloud' => array('group' => 'carrental-icons'),
					'icon icon-upload' => array('group' => 'carrental-icons'),
					'icon icon-download' => array('group' => 'carrental-icons'),
					'icon icon-target' => array('group' => 'carrental-icons'),
					'icon icon-hazardous' => array('group' => 'carrental-icons'),
					'icon icon-piechart' => array('group' => 'carrental-icons'),
					'icon icon-speedometer' => array('group' => 'carrental-icons'),
					'icon icon-global' => array('group' => 'carrental-icons'),
					'icon icon-compass' => array('group' => 'carrental-icons'),
					'icon icon-lifesaver' => array('group' => 'carrental-icons'),
					'icon icon-clock' => array('group' => 'carrental-icons'),
					'icon icon-aperture' => array('group' => 'carrental-icons'),
					'icon icon-quote' => array('group' => 'carrental-icons'),
					'icon icon-scope' => array('group' => 'carrental-icons'),
					'icon icon-alarmclock' => array('group' => 'carrental-icons'),
					'icon icon-refresh' => array('group' => 'carrental-icons'),
					'icon icon-happy' => array('group' => 'carrental-icons'),
					'icon icon-sad' => array('group' => 'carrental-icons'),
					'icon icon-facebook' => array('group' => 'carrental-icons'),
					'icon icon-twitter' => array('group' => 'carrental-icons'),
					'icon icon-googleplus' => array('group' => 'carrental-icons'),
					'icon icon-rss' => array('group' => 'carrental-icons'),
					'icon icon-tumblr' => array('group' => 'carrental-icons'),
					'icon icon-linkedin' => array('group' => 'carrental-icons'),
					'icon icon-dribbble' => array('group' => 'carrental-icons'),
					'icon icon-home' => array('group' => 'carrental-icons'),
					'icon icon-apartment' => array('group' => 'carrental-icons'),
					'icon icon-pencil1' => array('group' => 'carrental-icons'),
					'icon icon-magic-wand' => array('group' => 'carrental-icons'),
					'icon icon-drop' => array('group' => 'carrental-icons'),
					'icon icon-lighter' => array('group' => 'carrental-icons'),
					'icon icon-poop' => array('group' => 'carrental-icons'),
					'icon icon-sun' => array('group' => 'carrental-icons'),
					'icon icon-moon' => array('group' => 'carrental-icons'),
					'icon icon-cloud1' => array('group' => 'carrental-icons'),
					'icon icon-cloud-upload' => array('group' => 'carrental-icons'),
					'icon icon-cloud-download' => array('group' => 'carrental-icons'),
					'icon icon-cloud-sync' => array('group' => 'carrental-icons'),
					'icon icon-cloud-check' => array('group' => 'carrental-icons'),
					'icon icon-database' => array('group' => 'carrental-icons'),
					'icon icon-lock1' => array('group' => 'carrental-icons'),
					'icon icon-cog' => array('group' => 'carrental-icons'),
					'icon icon-trash' => array('group' => 'carrental-icons'),
					'icon icon-dice' => array('group' => 'carrental-icons'),
					'icon icon-heart1' => array('group' => 'carrental-icons'),
					'icon icon-star' => array('group' => 'carrental-icons'),
					'icon icon-star-half' => array('group' => 'carrental-icons'),
					'icon icon-star-empty' => array('group' => 'carrental-icons'),
					'icon icon-flag1' => array('group' => 'carrental-icons'),
					'icon icon-envelope1' => array('group' => 'carrental-icons'),
					'icon icon-paperclip1' => array('group' => 'carrental-icons'),
					'icon icon-inbox' => array('group' => 'carrental-icons'),
					'icon icon-eye' => array('group' => 'carrental-icons'),
					'icon icon-printer1' => array('group' => 'carrental-icons'),
					'icon icon-file-empty' => array('group' => 'carrental-icons'),
					'icon icon-file-add' => array('group' => 'carrental-icons'),
					'icon icon-enter' => array('group' => 'carrental-icons'),
					'icon icon-exit' => array('group' => 'carrental-icons'),
					'icon icon-graduation-hat' => array('group' => 'carrental-icons'),
					'icon icon-license' => array('group' => 'carrental-icons'),
					'icon icon-music-note' => array('group' => 'carrental-icons'),
					'icon icon-film-play' => array('group' => 'carrental-icons'),
					'icon icon-camera-video' => array('group' => 'carrental-icons'),
					'icon icon-camera1' => array('group' => 'carrental-icons'),
					'icon icon-picture1' => array('group' => 'carrental-icons'),
					'icon icon-book' => array('group' => 'carrental-icons'),
					'icon icon-bookmark' => array('group' => 'carrental-icons'),
					'icon icon-user' => array('group' => 'carrental-icons'),
					'icon icon-users' => array('group' => 'carrental-icons'),
					'icon icon-shirt' => array('group' => 'carrental-icons'),
					'icon icon-store' => array('group' => 'carrental-icons'),
					'icon icon-cart' => array('group' => 'carrental-icons'),
					'icon icon-tag' => array('group' => 'carrental-icons'),
					'icon icon-phone-handset' => array('group' => 'carrental-icons'),
					'icon icon-phone1' => array('group' => 'carrental-icons'),
					'icon icon-pushpin' => array('group' => 'carrental-icons'),
					'icon icon-map-marker' => array('group' => 'carrental-icons'),
					'icon icon-map1' => array('group' => 'carrental-icons'),
					'icon icon-location' => array('group' => 'carrental-icons'),
					'icon icon-calendar-full' => array('group' => 'carrental-icons'),
					'icon icon-keyboard' => array('group' => 'carrental-icons'),
					'icon icon-spell-check' => array('group' => 'carrental-icons'),
					'icon icon-screen' => array('group' => 'carrental-icons'),
					'icon icon-smartphone' => array('group' => 'carrental-icons'),
					'icon icon-tablet1' => array('group' => 'carrental-icons'),
					'icon icon-laptop1' => array('group' => 'carrental-icons'),
					'icon icon-laptop-phone' => array('group' => 'carrental-icons'),
					'icon icon-power-switch' => array('group' => 'carrental-icons'),
					'icon icon-bubble' => array('group' => 'carrental-icons'),
					'icon icon-heart-pulse' => array('group' => 'carrental-icons'),
					'icon icon-construction' => array('group' => 'carrental-icons'),
					'icon icon-pie-chart' => array('group' => 'carrental-icons'),
					'icon icon-chart-bars' => array('group' => 'carrental-icons'),
					'icon icon-gift1' => array('group' => 'carrental-icons'),
					'icon icon-diamond' => array('group' => 'carrental-icons'),
					'icon icon-dinner' => array('group' => 'carrental-icons'),
					'icon icon-coffee-cup' => array('group' => 'carrental-icons'),
					'icon icon-leaf' => array('group' => 'carrental-icons'),
					'icon icon-paw' => array('group' => 'carrental-icons'),
					'icon icon-rocket' => array('group' => 'carrental-icons'),
					'icon icon-briefcase1' => array('group' => 'carrental-icons'),
					'icon icon-bus' => array('group' => 'carrental-icons'),
					'icon icon-car' => array('group' => 'carrental-icons'),
					'icon icon-train' => array('group' => 'carrental-icons'),
					'icon icon-bicycle' => array('group' => 'carrental-icons'),
					'icon icon-wheelchair' => array('group' => 'carrental-icons'),
					'icon icon-select' => array('group' => 'carrental-icons'),
					'icon icon-earth' => array('group' => 'carrental-icons'),
					'icon icon-smile' => array('group' => 'carrental-icons'),
					'icon icon-sad1' => array('group' => 'carrental-icons'),
					'icon icon-neutral' => array('group' => 'carrental-icons'),
					'icon icon-mustache' => array('group' => 'carrental-icons'),
					'icon icon-alarm' => array('group' => 'carrental-icons'),
					'icon icon-bullhorn' => array('group' => 'carrental-icons'),
					'icon icon-volume-high' => array('group' => 'carrental-icons'),
					'icon icon-volume-medium' => array('group' => 'carrental-icons'),
					'icon icon-volume-low' => array('group' => 'carrental-icons'),
					'icon icon-volume' => array('group' => 'carrental-icons'),
					'icon icon-mic1' => array('group' => 'carrental-icons'),
					'icon icon-hourglass1' => array('group' => 'carrental-icons'),
					'icon icon-undo' => array('group' => 'carrental-icons'),
					'icon icon-redo' => array('group' => 'carrental-icons'),
					'icon icon-sync' => array('group' => 'carrental-icons'),
					'icon icon-history' => array('group' => 'carrental-icons'),
					'icon icon-clock1' => array('group' => 'carrental-icons'),
					'icon icon-download1' => array('group' => 'carrental-icons'),
					'icon icon-upload1' => array('group' => 'carrental-icons'),
					'icon icon-enter-down' => array('group' => 'carrental-icons'),
					'icon icon-exit-up' => array('group' => 'carrental-icons'),
					'icon icon-bug' => array('group' => 'carrental-icons'),
					'icon icon-code' => array('group' => 'carrental-icons'),
					'icon icon-link' => array('group' => 'carrental-icons'),
					'icon icon-unlink' => array('group' => 'carrental-icons'),
					'icon icon-thumbs-up' => array('group' => 'carrental-icons'),
					'icon icon-thumbs-down' => array('group' => 'carrental-icons'),
					'icon icon-magnifier' => array('group' => 'carrental-icons'),
					'icon icon-cross' => array('group' => 'carrental-icons'),
					'icon icon-menu' => array('group' => 'carrental-icons'),
					'icon icon-list' => array('group' => 'carrental-icons'),
					'icon icon-chevron-up' => array('group' => 'carrental-icons'),
					'icon icon-chevron-down' => array('group' => 'carrental-icons'),
					'icon icon-chevron-left' => array('group' => 'carrental-icons'),
					'icon icon-chevron-right' => array('group' => 'carrental-icons'),
					'icon icon-arrow-up' => array('group' => 'carrental-icons'),
					'icon icon-arrow-down' => array('group' => 'carrental-icons'),
					'icon icon-arrow-left' => array('group' => 'carrental-icons'),
					'icon icon-arrow-right' => array('group' => 'carrental-icons'),
					'icon icon-move' => array('group' => 'carrental-icons'),
					'icon icon-warning' => array('group' => 'carrental-icons'),
					'icon icon-question-circle' => array('group' => 'carrental-icons'),
					'icon icon-menu-circle' => array('group' => 'carrental-icons'),
					'icon icon-checkmark-circle' => array('group' => 'carrental-icons'),
					'icon icon-cross-circle' => array('group' => 'carrental-icons'),
					'icon icon-plus-circle' => array('group' => 'carrental-icons'),
					'icon icon-circle-minus' => array('group' => 'carrental-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'carrental-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'carrental-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'carrental-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'carrental-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'carrental-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'carrental-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'carrental-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'carrental-icons'),
					'icon icon-crop' => array('group' => 'carrental-icons'),
					'icon icon-frame-expand' => array('group' => 'carrental-icons'),
					'icon icon-frame-contract' => array('group' => 'carrental-icons'),
					'icon icon-layers1' => array('group' => 'carrental-icons'),
					'icon icon-funnel' => array('group' => 'carrental-icons'),
					'icon icon-text-format' => array('group' => 'carrental-icons'),
					'icon icon-text-size' => array('group' => 'carrental-icons'),
					'icon icon-bold' => array('group' => 'carrental-icons'),
					'icon icon-italic' => array('group' => 'carrental-icons'),
					'icon icon-underline' => array('group' => 'carrental-icons'),
					'icon icon-strikethrough' => array('group' => 'carrental-icons'),
					'icon icon-highlight' => array('group' => 'carrental-icons'),
					'icon icon-text-align-left' => array('group' => 'carrental-icons'),
					'icon icon-text-align-center' => array('group' => 'carrental-icons'),
					'icon icon-text-align-right' => array('group' => 'carrental-icons'),
					'icon icon-text-align-justify' => array('group' => 'carrental-icons'),
					'icon icon-line-spacing' => array('group' => 'carrental-icons'),
					'icon icon-indent-increase' => array('group' => 'carrental-icons'),
					'icon icon-indent-decrease' => array('group' => 'carrental-icons'),
					'icon icon-page-break' => array('group' => 'carrental-icons'),
					'icon icon-hand' => array('group' => 'carrental-icons'),
					'icon icon-pointer-up' => array('group' => 'carrental-icons'),
					'icon icon-pointer-right' => array('group' => 'carrental-icons'),
					'icon icon-pointer-down' => array('group' => 'carrental-icons'),
					'icon icon-pointer-left' => array('group' => 'carrental-icons'),
					'icon icon-vplay' => array('group' => 'carrental-icons'),
					'icon icon-newsletter' => array('group' => 'carrental-icons'),
					'icon icon-coins-2' => array('group' => 'carrental-icons'),
					'icon icon-commerce-2' => array('group' => 'carrental-icons'),
					'icon icon-monitor' => array('group' => 'carrental-icons'),
					'icon icon-graphic-3' => array('group' => 'carrental-icons'),
					'icon icon-business' => array('group' => 'carrental-icons'),
					'icon icon-graphic-2' => array('group' => 'carrental-icons'),
					'icon icon-commerce-1' => array('group' => 'carrental-icons'),
					'icon icon-hammer' => array('group' => 'carrental-icons'),
					'icon icon-graphic-1' => array('group' => 'carrental-icons'),
					'icon icon-graphic' => array('group' => 'carrental-icons'),
					'icon icon-justice-1' => array('group' => 'carrental-icons'),
					'icon icon-line' => array('group' => 'carrental-icons'),
					'icon icon-money-3' => array('group' => 'carrental-icons'),
					'icon icon-chart' => array('group' => 'carrental-icons'),
					'icon icon-commerce' => array('group' => 'carrental-icons'),
					'icon icon-agenda' => array('group' => 'carrental-icons'),
					'icon icon-money-2' => array('group' => 'carrental-icons'),
					'icon icon-justice' => array('group' => 'carrental-icons'),
					'icon icon-money-1' => array('group' => 'carrental-icons'),
					'icon icon-money' => array('group' => 'carrental-icons'),
					'icon icon-technology' => array('group' => 'carrental-icons'),
					'icon icon-coins-1' => array('group' => 'carrental-icons'),
					'icon icon-coins' => array('group' => 'carrental-icons'),
					'icon icon-left-arrow' => array('group' => 'carrental-icons'),
					'icon icon-bank' => array('group' => 'carrental-icons'),
					'icon icon-calculator' => array('group' => 'carrental-icons'),
					'icon icon-chart1' => array('group' => 'carrental-icons'),
					'icon icon-chart2' => array('group' => 'carrental-icons'),
					'icon icon-checked' => array('group' => 'carrental-icons'),
					'icon icon-clock2' => array('group' => 'carrental-icons'),
					'icon icon-comment' => array('group' => 'carrental-icons'),
					'icon icon-comments' => array('group' => 'carrental-icons'),
					'icon icon-consult' => array('group' => 'carrental-icons'),
					'icon icon-consut2' => array('group' => 'carrental-icons'),
					'icon icon-deal' => array('group' => 'carrental-icons'),
					'icon icon-download2' => array('group' => 'carrental-icons'),
					'icon icon-envelope2' => array('group' => 'carrental-icons'),
					'icon icon-euro' => array('group' => 'carrental-icons'),
					'icon icon-folder' => array('group' => 'carrental-icons'),
					'icon icon-invest' => array('group' => 'carrental-icons'),
					'icon icon-loan' => array('group' => 'carrental-icons'),
					'icon icon-map-marker1' => array('group' => 'carrental-icons'),
					'icon icon-mutual-fund' => array('group' => 'carrental-icons'),
					'icon icon-percent' => array('group' => 'carrental-icons'),
					'icon icon-phone2' => array('group' => 'carrental-icons'),
					'icon icon-pie-chart1' => array('group' => 'carrental-icons'),
					'icon icon-play' => array('group' => 'carrental-icons'),
					'icon icon-left-arrow2' => array('group' => 'carrental-icons'),
					'icon icon-savings' => array('group' => 'carrental-icons'),
					'icon icon-search1' => array('group' => 'carrental-icons'),
					'icon icon-tag1' => array('group' => 'carrental-icons'),
					'icon icon-tags' => array('group' => 'carrental-icons'),
					'icon icon-tax' => array('group' => 'carrental-icons'),
					'icon icon-quote1' => array('group' => 'carrental-icons'),
					'icon icon-right-arrow2' => array('group' => 'carrental-icons'),
