<div class="post-media post-video">
   ...
   <?php
   if( defined( 'FW' ) && carrental_meta_option(get_the_ID(),'featured_video')!=''):
   ?>
         <div class="video-link-btn">
            <a href="<?php echo carrental_meta_option(get_the_ID(),'featured_video'); ?>" class="play-btn popup-btn"><i class="icon icon-play"></i></a>
         </div>
         <?php endif; ?>
               <?php
                  $date_style = carrental_option('blog_date_style','classic');
                  if ( $date_style == "creative" ) :
                        carrental_post_meta_date();
                  endif;
               ?>
         <?php endif; ?>
         </div>
