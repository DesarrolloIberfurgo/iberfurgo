<?php
 ...
 $blog_related_post = carrental_option('blog_related_post','no');
 $blog_related_post_number = carrental_option('blog_related_post_number',3);

?>
<?php if($blog_related_post=="yes"): ?>
   <?php
      $related_post = carrental_related_posts_by_tags($post->ID,$blog_related_post_number);
      ?>
      <div class="related-post-title-wraper">
         <h2 class="related-post-title"><?php echo esc_html__( "Releated Posts", "carrental" )?></h2>
      </div>
      <div class="row">
      <?php
