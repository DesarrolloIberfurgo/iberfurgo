...
if ( defined( 'DEVM' ) ) {
	...
	$woo_single_show_banner   = carrental_option('woo_single_show_banner');
	if ("yes" !== $woo_single_show_banner) {
		return;
	}

	$banner_woo_single_image       = carrental_option('banner_woo_single_image');
	$banner_overlay                = carrental_option('show_woo_single_banner_overlay');
	$banner_image                  = CARRENTAL_IMG.'/banner/bredcumbs-1.png';
	$woo_single_banner_title_color = carrental_option('woo_single_banner_title_color');
	...
	$banner_overlay                = "yes";
	$banner_image                  = CARRENTAL_IMG.'/banner/bredcumbs-1.png';
	$woo_single_banner_title_color = "#010103";
}
if( $banner_image != ''){
...
<section class="xs-jumbotron d-flex align-items-center  xs_single_blog_banner  banner-bg" <?php echo wp_kses_post( $banner_image ); ?>>
	<?php if ($banner_overlay === 'yes') {
		...
		if ( defined( 'DEVM' ) ) {
			$banner_overlay_color = carrental_option("woo_single_banner_overlay_color");
		}
		?>
		...
		<div class="row">
			<div class="col-12">
				<div class="xs-jumbotron-content-wraper">
					<h1 class="xs-jumbotron-title" style="color: <?php echo esc_attr($woo_single_banner_title_color === '' ? '#010103' : $woo_single_banner_title_color); ?>">
						<?php
						if(is_archive()){
							the_archive_title();
						}elseif(is_single()){
