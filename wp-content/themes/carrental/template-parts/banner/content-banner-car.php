...
if ( defined( 'FW' ) ) {
   $banner_settings         = carrental_option('service_banner_settings');
   $header_style            = carrental_option('header_layout_style', 'standard');

   //image
   $banner_image = ( is_array($banner_settings['image']) && $banner_settings['image']['url'] != '') ?
                        $banner_settings['image']['url'] : CARRENTAL_IMG.'/banner/service_details_banner.jpg';
