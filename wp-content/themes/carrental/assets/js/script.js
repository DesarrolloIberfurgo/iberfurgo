...
(function ($) {
  ...
  $('.elementskit-mobile-builder-content').click(function() {
	$('#ekit-megamenu-navigation').removeClass('active');
	$('.elementskit-menu-overlay.elementskit-menu-offcanvas-elements.elementskit-menu-toggler').removeClass('active');
  });
