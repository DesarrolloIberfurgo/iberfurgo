...
function grandcarrental_add_admin() 
{
	...
	add_menu_page('Theme Setting', 'Theme Setting', 'administrator', 'functions.php', 'grandcarrental_admin', '', 3);
}
...
add_action('wp_ajax_grandcarrental_script_testimonials_flexslider', 'grandcarrental_script_testimonials_flexslider');
add_action('wp_ajax_nopriv_grandcarrental_script_testimonials_flexslider', 'grandcarrental_script_testimonials_flexslider');

function grandcarrental_script_testimonials_flexslider() {
