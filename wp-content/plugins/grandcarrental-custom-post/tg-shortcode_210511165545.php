...
function tg_button_func($atts, $content) {
	...
	$shadow_color = '#'.grandcarrental_hex_darker(substr($bg_color, 1), 12);
...
function tg_social_share_func($atts, $content) {
	...
	$return_html.='<h5>'.esc_html__( 'Share On', 'grandcarrental-custom-post' ).'</h5><br/><br/>';
	$return_html.='<ul>';
...
function tg_map_func($atts) {
	...
	wp_enqueue_script("grandcarrental-script-contact-map".$custom_id, admin_url('admin-ajax.php')."?action=grandcarrental_script_map_shortcode&data=".$ext_attr_serialize, false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_tab_func($atts, $content) {
	...
	wp_enqueue_script('grandcarrental-custom-tab', get_template_directory_uri()."/js/custom-tab.js", false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_accordion_oficinas_func($atts, $content) {
	...
	$return_html.= '<p><i class="fas fa-at ibf_font_20 ibf_color_orange ibf_pr_10"></i><a class="ibf_font_16" href="mailto:'.$email.'">'.$email.'</a></p>';
...
function tg_divider_func($atts, $content) {
	...
	if($style == 'totop')
	{
		$return_html.= '<a class="hr_totop" href="#">'.esc_html__( 'Go to top', 'grandcarrental-custom-post' ).'&nbsp;<i class="fa fa-arrow-up"></i></a>';
	}
...
function tg_testimonial_slider_func($atts, $content) {
	...
	wp_enqueue_script("grandcarrental-sciprt-testimonials-flexslider", get_template_directory_uri()."/templates/script-testimonials-flexslider.php", false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_animate_counter_func($atts, $content) {
	...
	wp_enqueue_style("odometer", get_template_directory_uri()."/css/odometer-theme-minimal.css", false, GRANDCARRENTAL_THEMEVERSION, "all");
	wp_enqueue_script("odometer", get_template_directory_uri()."/js/odometer.min.js", false, GRANDCARRENTAL_THEMEVERSION, true);
	
	wp_enqueue_script("grandcarrental-script-animate-counter".$custom_id, admin_url('admin-ajax.php')."?action=grandcarrental_script_animate_counter_shortcode&id=".$custom_id."&start=".$start."&end=".$end."&fontsize=".$fontsize, false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_animate_circle_func($atts, $content) {
	...
	wp_enqueue_style("circliful", get_template_directory_uri()."/css/jquery.circliful.css", false, GRANDCARRENTAL_THEMEVERSION, "all");
	wp_enqueue_script("circliful", get_template_directory_uri()."/js/jquery.circliful.min.js", false, GRANDCARRENTAL_THEMEVERSION, true);
	wp_enqueue_script("grandcarrental-script-animate-circle".$custom_id, admin_url('admin-ajax.php')."?action=grandcarrental_script_animate_circle_shortcode&id=".$custom_id, false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_gallery_slider_func($atts, $content) {
	...
	wp_enqueue_script("flexslider", get_template_directory_uri()."/js/flexslider/jquery.flexslider-min.js", false, GRANDCARRENTAL_THEMEVERSION, true);
	wp_enqueue_script("grandcarrental-script-gallery-flexslider-".$custom_id, admin_url('admin-ajax.php')."?action=grandcarrental_script_gallery_flexslider&id=".$custom_id."&autoplay=".$autoplay.'&caption='.$caption.'&timer='.$timer, false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_audio_func($atts, $content) {
	...
	wp_enqueue_style("mediaelementplayer", get_template_directory_uri()."/js/mediaelement/mediaelementplayer.css", false, GRANDCARRENTAL_THEMEVERSION, "all");
	
	wp_enqueue_script("mediaelement-and-player", get_template_directory_uri()."/js/mediaelement/mediaelement-and-player.min.js", false, GRANDCARRENTAL_THEMEVERSION);
	
	wp_enqueue_script("grandcarrental-script-audio-shortcode", admin_url('admin-ajax.php')."?action=grandcarrental_script_audio_shortcode&id=".$custom_id, false, GRANDCARRENTAL_THEMEVERSION, true);
...
function tg_jwplayer_func($atts, $content) {
	...
	wp_enqueue_script("swfobject", "https://ajax.googleapis.com/ajax/libs/swfobject/2.1/swfobject.js", false, GRANDCARRENTAL_THEMEVERSION, true);
	
	wp_enqueue_script("jwplayer", get_template_directory_uri()."/js/jwplayer.js", false, GRANDCARRENTAL_THEMEVERSION);
	wp_enqueue_script("mediaelement-and-player.min", get_template_directory_uri()."/js/mediaelement/mediaelement-and-player.min.js", false, GRANDCARRENTAL_THEMEVERSION);
	wp_enqueue_script("grandcarrental-script-jwplayer-shortcode".$id, admin_url('admin-ajax.php')."?action=grandcarrental_script_jwplayer_shortcode&id=".$id."&file=".$file."&image=".$image."&width=".$width."&height=".$height, false, GRANDCARRENTAL_THEMEVERSION, true);
}
...
function googlefont_func($atts, $content) {
	...
	if(!empty($font))
	{
		...
		wp_enqueue_style('grandcarrental-'.$encoded_font, "https://fonts.googleapis.com/css?family=".$encoded_font, false, "", "all");
