 ...
 * recent post widget
 */
class CARRENTAL_Recent_Post extends WP_Widget {

	function __construct() {

		$widget_opt = array(
			'classname'		 => 'CARRENTAL-widget',
			'description'	 => esc_html__('Recent post with thumbnail','carrental-essential')
		);

		parent::__construct( 'xs-recent-post', esc_html__( 'CARRENTAL recent post', 'carrental-essential' ), $widget_opt );
	}
		...
		<div class="widget-posts">
				...
				while ( $loop->have_posts() ):
					...
					<div class="widget-post media">
						<?php
							...
							echo '<a href="'.get_the_permalink().'"><img src="' . esc_url( $img ) . '" alt="' . esc_attr__('thumb','carrental-essential') . '"></a>';
							?>
			...
			<?php else: ?>
				<div class="nopost_message">
					<p><?php echo esc_html__( 'No post avainable', 'carrental-essential' ) ?></p>';
				</div>
			<?php endif; ?>
			</div>
		<?php
	...
	function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Recent posts', 'carrental-essential' );
		}
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number_of_posts' ) ); ?>"><?php esc_html_e( 'Number of posts:', 'carrental-essential' ); ?></label>
