...
class CARRENTAL_Instagram extends WP_Widget
{
    function __construct() {

        $widget_opt = array(
            'classname'     => 'CARRENTAL-widget',
            'description'   => 'CARRENTAL instagrams'
        );

        parent::__construct('CARRENTAL-instagram', esc_html__('CARRENTAL instagram', 'carrental-essential'), $widget_opt);
    }
    ...
    function form($instance){
        ...
        $user_id = '';
        $media_count = 10;
        $title = esc_html__( 'Instagram', 'carrental-essential' );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'carrental-essential' ); ?></label>
        ...
        <p>
            ...
            <?php esc_html__( 'Log in and get my Access Token and User ID' , 'carrental-essential' ); ?>
            </a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'access_token' )); ?>"><?php esc_html__( 'Access token:' , 'carrental-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user_id' )); ?>"><?php esc_html__( 'User ID:' , 'carrental-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_count' )); ?>"><?php esc_html__( 'Count:' , 'carrental-essential' ); ?></label>
