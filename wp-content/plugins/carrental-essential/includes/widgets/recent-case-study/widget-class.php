 ...
 * recent post widget
 */
class CARRENTAL_Recent_Case_study extends WP_Widget {

    function __construct() {

        $widget_opt = array(
            'classname'		 => 'CARRENTAL-widget',
            'description'	 => esc_html__('Recent case study','carrental-essential')
        );

        parent::__construct( 'xs-recent-case-study', esc_html__( 'Recent case study', 'carrental-essential' ), $widget_opt );
    }
    ...
    function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Latest Updates', 'carrental-essential' );
        }
