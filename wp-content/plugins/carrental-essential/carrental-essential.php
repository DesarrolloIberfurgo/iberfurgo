<?php
/*
* Plugin Name: CarRental Essentials
* License - GNU/GPL V2 or Later
* Description: This is a required plugin for CarRental theme.
* Version: 3.1
* text domain: carrental-essential
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
// Add language
add_action( 'init', 'carrental_language_load' );
function carrental_language_load(){
    $plugin_dir = basename(dirname(__FILE__))."/languages/";
    load_plugin_textdomain( 'carrental-essential', false, $plugin_dir );
}

// main class
class CarRental_Essentials_Includes {
      // auto load
    // ----------------------------------------------------------------------------------------
	...
	public static function include_widget( $widget_dir ) {
		...
		register_widget( 'CARRENTAL_' . self::dirname_to_classname( $widget_dir ) );
	}
...
CarRental_Essentials_Includes::init();
