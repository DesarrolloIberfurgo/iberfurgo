						...
						<div class="tab-content-inside">
							...
							<?php if( empty( $this->qc_choice_cmp_utid ) || empty( $this->qc_choice_cmp_enable ) ) { ?>
								<h1 class="update-headline">
									<?php _e( '** Important - REQUIRED Update to TCF v2.0 **', 'qc-choice' ); ?>
								</h1>
										...
										<td>
											...
											<div class="desc">
												<div>
													<?php printf(
														__(
															'* Enter your UTID/pCode <strong>WITHOUT</strong> the leading "p-" ( <strong style="color:red">Incorrect</strong>: p-xxxxxxxxxxxxx -> Update to -> <strong>Correct</strong>: xxxxxxxxxxxxx)',
															'qc-choice'
														)
													); ?>
												</div>
